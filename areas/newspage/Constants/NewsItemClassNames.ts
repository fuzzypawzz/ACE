export default class NewsItemClassNames {
  ...
  static readonly authorAndDateWrapper: string = "newsblock-01-infos";
  static readonly author: string =
    "newsblock-01-headline news-headline pebble-purple";
  static readonly date: string = "newsblock-01-date";
