...
/***/ "./areas/humany-notification-detector/index.ts":
/*!*****************************************************!*\
  !*** ./areas/humany-notification-detector/index.ts ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _search_result_extender_functions_getUrlParameterByName__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../search-result-extender/functions/getUrlParameterByName */ "./areas/search-result-extender/functions/getUrlParameterByName.ts");

var HumanyNotificationDetector = /** @class */ (function () {
    function HumanyNotificationDetector(config) {
    ...
    HumanyNotificationDetector.prototype.returnUrlParam = function (param) {
        return Object(_search_result_extender_functions_getUrlParameterByName__WEBPACK_IMPORTED_MODULE_0__["default"])(param);
    };
    HumanyNotificationDetector.prototype.setInputFieldValue = function () {
        var _this = this;
        var inputs = document.querySelectorAll(this.InputFieldSelector);
        inputs.forEach(function (element) {
            if (element.name == _this.targetInputName) {
                element.value = _this.returnUrlParam(_this.searchKey);
            }
        });
    };
    return HumanyNotificationDetector;
}());
/* harmony default export */ __webpack_exports__["default"] = (HumanyNotificationDetector);
...
var NewsItemClassNames = /** @class */ (function () {
    ...
    NewsItemClassNames.sectionWrapper = "newsSection-wrapper2222";
    NewsItemClassNames.itemWrapper = "newsblock-01-wrapper";
    ...
    NewsItemClassNames.latestNewsContainer = "latest-news-container";
...
var BaseTemplateElement = /** @class */ (function () {
    function BaseTemplateElement(data) {
...
/*!*****************************************************************!*\
  !*** ./areas/newspage/TemplateEngine/createNewsItemTemplate.ts ***!
  \*****************************************************************/
/*! exports provided: newsBlockTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "newsBlockTemplate", function() { return newsBlockTemplate; });
...
/* harmony import */ var _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Constants/TableKeys */ "./areas/newspage/Constants/TableKeys.ts");

var Handlebars = __webpack_require__(/*! handlebars */ "./node_modules/handlebars/dist/cjs/handlebars.js");

// TODO: Multiple links should be rendered as buttons
var newsBlockTemplate = Handlebars.compile("\n    <div class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].sectionWrapper + "\">\n    {{#each entries}}\n        <div class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].itemWrapper + "\">\n            <section class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].header + "\">\n                {{#if ../logo}}\n                    <div class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].logoWrapper + "\">\n                        {{../logo}}\n                    </div>\n                {{/if}}\n                <div class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].authorAndDateWrapper + "\">\n                    <h2 class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].author + "\"> {{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].AUTHOR + " }} </h2>\n                    <h3 class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].date + "\"> {{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].DATE_STRING + " }} </h3>\n                </div>\n            </section>\n            <section class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].newsContentWrapper + "\">\n                <h3 class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].newsContentHeadline + "\"> {{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].HEADLINE + " }} </h3>\n                <section class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].newsContentBody + "\"> {{{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].CONTENT_TEXT + " }}} </section>\n            </section>\n            {{#if this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].IMG + "}}\n                <section class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].newsContentPhotos + "\">\n                    {{{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].IMG + " }}}\n                </section>\n            {{/if}}\n            {{#if this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].HREF + "}}\n                <section class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].newsContentLinks + "\">\n                    {{{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].HREF + " }}}\n                </section>\n            {{/if}}\n        </div>\n        {{/each}}\n    </div>\n");
...
/* harmony import */ var _newspage_functions_returnTableInBody__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../newspage/functions/returnTableInBody */ "./areas/newspage/functions/returnTableInBody.ts");
/* harmony import */ var _newspage_functions_tableDataTrimmer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../newspage/functions/tableDataTrimmer */ "./areas/newspage/functions/tableDataTrimmer.ts");
/* harmony import */ var _Constants_ErrorMessages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Constants/ErrorMessages */ "./areas/newspage/Constants/ErrorMessages.ts");
/* harmony import */ var _functions_provideIds__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/provideIds */ "./areas/newspage/functions/provideIds.ts");
/* harmony import */ var _TemplateEngine_BaseTemplateElement__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TemplateEngine/BaseTemplateElement */ "./areas/newspage/TemplateEngine/BaseTemplateElement.ts");
/* harmony import */ var _TemplateEngine_createNewsItemTemplate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./TemplateEngine/createNewsItemTemplate */ "./areas/newspage/TemplateEngine/createNewsItemTemplate.ts");
/* harmony import */ var _templates_latestNewsContainer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./templates/latestNewsContainer */ "./areas/newspage/templates/latestNewsContainer.ts");
...
var NewsPage = /** @class */ (function () {
    ...
    NewsPage.prototype.handler = function (htmlBody) {
        var table = Object(_newspage_functions_returnTableInBody__WEBPACK_IMPORTED_MODULE_2__["default"])(htmlBody, this.tableElementId);
        if (!table) {
            throw new Error(_Constants_ErrorMessages__WEBPACK_IMPORTED_MODULE_4__["ErrorMessages"].couldNotFindTableId);
        }
        var tableDataList = new _services_HtmlTableParser__WEBPACK_IMPORTED_MODULE_1__["default"](table).tableDataToList();
        var trimmedData = Object(_newspage_functions_tableDataTrimmer__WEBPACK_IMPORTED_MODULE_3__["default"])(tableDataList);
        this.tableData = Object(_functions_provideIds__WEBPACK_IMPORTED_MODULE_5__["default"])(trimmedData);
        this.updateDOM(Object(_TemplateEngine_createNewsItemTemplate__WEBPACK_IMPORTED_MODULE_7__["newsBlockTemplate"])({
            entries: this.tableData,
            logo: "logo",
        }), "body");
        // Container for showing the 10 latest entries in simplified format
        this.updateDOM(Object(_templates_latestNewsContainer__WEBPACK_IMPORTED_MODULE_8__["latestNewsContainer"])({
            entries: this.tableData,
    ...
    NewsPage.prototype.updateDOM = function (html, targetId) {
        // TODO: Refactor this
        var target = document.querySelector("#" + targetId);
        var element = new _TemplateEngine_BaseTemplateElement__WEBPACK_IMPORTED_MODULE_6__["default"]().returnElement();
        element.innerHTML = html;
        target
            ? target.appendChild(element)
            : console.error("updateDOM: " + _Constants_ErrorMessages__WEBPACK_IMPORTED_MODULE_4__["ErrorMessages"].COULD_NOT_UPDATE_DOM);
    };
    return NewsPage;
}());
...
/***/ "./areas/newspage/templates/latestNewsContainer.ts":
/*!*********************************************************!*\
  !*** ./areas/newspage/templates/latestNewsContainer.ts ***!
  \*********************************************************/
/*! exports provided: latestNewsContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "latestNewsContainer", function() { return latestNewsContainer; });
/* harmony import */ var _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Constants/NewsItemClassNames */ "./areas/newspage/Constants/NewsItemClassNames.ts");
/* harmony import */ var _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Constants/TableKeys */ "./areas/newspage/Constants/TableKeys.ts");


var Handlebars = __webpack_require__(/*! handlebars */ "./node_modules/handlebars/dist/cjs/handlebars.js");
Handlebars.registerHelper("determineNewsFromTodayText", function (count) {
    var integer = parseInt(count, 10);
    return integer == 1 ? "nyhed fra i dag" : "nyheder fra i dag";
});
var latestNewsContainer = Handlebars.compile("\n    <div id=\"HumanyCustom-latest-news\" class=\"" + _Constants_NewsItemClassNames__WEBPACK_IMPORTED_MODULE_0__["default"].latestNewsContainer + "\" style=\"display: block;\">\n        <div class=\"HumanyCustom-latest-news-header\">\n            <h4 class=\"HumanyCustom-latest-news-headline\">\n                <i class=\"fa fa-inbox\">\n                    <span class=\"tsPebble spanBeforeIcon\">{{ latestNewsHeadline }}</span>\n                </i>\n            </h4>\n            <p class=\"humany-latest-news-counter\">\n                Der er <span class=\"newsCountBadge\">{{ newsFromTodayCounter }}</span>\n                {{ determineNewsFromTodayText newsFromTodayCounter }}\n            </p>\n        </div>\n        {{#each entries}}\n            <div class=\"latestNewsItem\">\n                <div class=\"latestNewsHeadline\">\n                    <i class=\"fa fa-info-circle iconToTextGap tsPurple\"></i>\n                    {{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].HEADLINE + " }}\n                </div>\n                <div class=\"latestNewsDate\">{{ this." + _Constants_TableKeys__WEBPACK_IMPORTED_MODULE_1__["default"].DATE_STRING + " }}</div>\n            </div>\n        {{/each}}\n    </div>\n");


/***/ }),

/***/ "./areas/search-result-extender/constants/ClassNames.ts":
/*!**************************************************************!*\
  !*** ./areas/search-result-extender/constants/ClassNames.ts ***!
  \**************************************************************/
/*! exports provided: default */
...
var ClassNames = /** @class */ (function () {
    ...
    ClassNames.wrapper = "no-result-info-wrapper";
    ClassNames.text = "no-result-info-text";
    ClassNames.button = "button1";
    return ClassNames;
}());
...
/***/ "./areas/search-result-extender/constants/Ids.ts":
/*!*******************************************************!*\
  !*** ./areas/search-result-extender/constants/Ids.ts ***!
  \*******************************************************/
/*! exports provided: default */
...
var Ids = /** @class */ (function () {
    ...
    Ids.searchResultInfoBoxId = "superwoman-no-result";
    return Ids;
}());
...
/***/ "./areas/search-result-extender/functions/getUrlParameterByName.ts":
/*!*************************************************************************!*\
  !*** ./areas/search-result-extender/functions/getUrlParameterByName.ts ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getUrlParameterByName; });
...
/***/ "./areas/search-result-extender/index.ts":
/*!***********************************************!*\
  !*** ./areas/search-result-extender/index.ts ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _constants_Ids__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants/Ids */ "./areas/search-result-extender/constants/Ids.ts");
/* harmony import */ var _functions_getUrlParameterByName__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/getUrlParameterByName */ "./areas/search-result-extender/functions/getUrlParameterByName.ts");
/* harmony import */ var _templates_searchResultInfoBox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./templates/searchResultInfoBox */ "./areas/search-result-extender/templates/searchResultInfoBox.ts");
/* harmony import */ var _templates_superWomanSvg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./templates/superWomanSvg */ "./areas/search-result-extender/templates/superWomanSvg.ts");




var SearchResultExtender = /** @class */ (function () {
    function SearchResultExtender(config) {
        this.stringToQuery = "Ingen resultater";
        this.searchKey = "searchkey";
    ...
    SearchResultExtender.prototype.getTargetElement = function () {
        var _this = this;
        ...
        this.targetListElement.forEach(function (node) {
            var targets = node.parentNode.querySelectorAll("em");
            targets.forEach(function (element) {
                if (element.innerText == _this.stringToQuery) {
    ...
    SearchResultExtender.prototype.createInfoBox = function () {
        var targetElement = this.getTargetElement();
        if (targetElement) {
            var template = Object(_templates_searchResultInfoBox__WEBPACK_IMPORTED_MODULE_2__["searchResultInfoBox"])({
                svg: Object(_templates_superWomanSvg__WEBPACK_IMPORTED_MODULE_3__["superWomanSvg"])(),
                infoText: this.infoText,
                buttonText: this.buttonText,
            });
            var element = document.createElement("DIV");
            element.innerHTML = template;
            var redirectUrl_1 = this.onClickRedirectUrl;
            var searchKey_1 = this.searchKey;
            if (redirectUrl_1) {
                this.addButtonClickListener(element.querySelector("button"), function () {
                    location.href = redirectUrl_1 + "&" + searchKey_1 + "=" + Object(_functions_getUrlParameterByName__WEBPACK_IMPORTED_MODULE_1__["default"])("phrase");
                });
            }
    ...
    SearchResultExtender.prototype.infoBoxExistsAlready = function () {
        if (document.querySelector("#" + _constants_Ids__WEBPACK_IMPORTED_MODULE_0__["default"].searchResultInfoBoxId)) {
            return true;
        }
        else {
            return false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return setupObserver; });
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_other_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! -!../../../node_modules/css-loader/dist/cjs.js!./other.css */ "./node_modules/css-loader/dist/cjs.js!./areas/newspage/scss/other.css");
// Imports



var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()(_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default.a);
___CSS_LOADER_EXPORT___.i(_node_modules_css_loader_dist_cjs_js_other_css__WEBPACK_IMPORTED_MODULE_2__["default"]);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "/* TODO: Use SASS */\n\n", "",{"version":3,"sources":["webpack://./areas/newspage/scss/main.css"],"names":[],"mappings":"AAAA,mBAAmB","sourcesContent":["/* TODO: Use SASS */\n@import \"./other.css\";\n\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()(_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default.a);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body {\n    background-color: aliceblue;\n}", "",{"version":3,"sources":["webpack://./areas/newspage/scss/other.css"],"names":[],"mappings":"AAAA;IACI,2BAA2B;AAC/B","sourcesContent":["body {\n    background-color: aliceblue;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js");
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_areas_newspage_scss_main_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! -!../node_modules/css-loader/dist/cjs.js!../areas/newspage/scss/main.css */ "./node_modules/css-loader/dist/cjs.js!./areas/newspage/scss/main.css");
// Imports



var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()(_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default.a);
___CSS_LOADER_EXPORT___.i(_node_modules_css_loader_dist_cjs_js_areas_newspage_scss_main_css__WEBPACK_IMPORTED_MODULE_2__["default"]);
// Module
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: ModalInitiater, ButtonSetup, NewsPage, SearchResultExtender, HumanyNotificationDetector, createAttemptFunc, setupObserver, setup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _areas_search_result_extender_index_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../areas/search-result-extender/index.ts */ "./areas/search-result-extender/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SearchResultExtender", function() { return _areas_search_result_extender_index_ts__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _areas_humany_notification_detector__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../areas/humany-notification-detector */ "./areas/humany-notification-detector/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HumanyNotificationDetector", function() { return _areas_humany_notification_detector__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _helpers_initiateAttemptFunc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/initiateAttemptFunc */ "./helpers/initiateAttemptFunc.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createAttemptFunc", function() { return _helpers_initiateAttemptFunc__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony import */ var _helpers_setupObserver__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helpers/setupObserver */ "./helpers/setupObserver.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setupObserver", function() { return _helpers_setupObserver__WEBPACK_IMPORTED_MODULE_6__["default"]; });

/* harmony import */ var _setup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./setup */ "./src/setup.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setup", function() { return _setup__WEBPACK_IMPORTED_MODULE_7__["default"]; });
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  function setupResultInfoBox() {
    ...
    var targetList = document.querySelectorAll(".h-portal-list");
    var configuration = {
      targetListElement: targetList,
      stringToQuery: "Ingen resultater",
      onClickRedirectUrl: "?contact-method=14515",
      searchKey: "searchkey",
      infoText: "Vær en ægte Telia helt og super-kollega, og lad os vide at der mangler en guide. Klik blot herunder:",
  ...
  function convertLinksToIcons() {
    ...
    if (isGuideShown) {
      var handler = function handler(iconClass, node, title) {
      ...
      nodes.forEach(function (node) {
        try {
          ...
          if (node.innerText.includes("%camera%")) {
            container.appendChild(handler("fa fa-camera", node, "Gå til billede-guide"));
          }
        } catch (err) {}
      });
    }
